...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const o=document.querySelector("iframe"),r=new Vimeo.Player(o),l=e=>{localStorage.setItem("videoplayer-current-time",e.seconds)};r.on("timeupdate",l);const c=localStorage.getItem("videoplayer-current-time");r.setCurrentTime(c).then(e=>{console.log("hello world")}).catch(()=>console.log(oshibka));
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw-08/02-video.8c354f41.js.map